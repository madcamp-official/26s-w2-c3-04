...
- **산출물 주제:** AI 기반 포즈 인식 및 맞춤형 프레임 생성이 가능한 네컷사진 서비스 **'만능네컷'**

- **제작 목적:**
  - 네컷사진 촬영 시 가장 큰 고민인 '어떤 포즈를 취할지'를 AI가 해결해주는 서비스이다.
  - 사용자는 AI가 제시하는 포즈를 따라 하기만 하면 되며, 포즈를 정확하게 인식하면 자동으로 사진이 촬영되어 쉽고 재미있는 촬영 경험을 제공한다.
  - 또한 AI가 사용자의 프롬프트를 바탕으로 맞춤형 사진 프레임을 생성하여 기존 네컷사진보다 높은 개인화 경험을 제공한다.
- **선택 옵션:**

- **핵심 구현 요소:**
  - AI가 랜덤 또는 상황에 맞는 손동작/포즈를 제안
  - 카메라 영상에서 사용자의 포즈를 실시간으로 인식하고, 포즈가 일치하면 3초 카운트다운 후 자동 촬영
  - 포즈별 최대 2회 촬영 기회를 제공하여 총 8장의 사진 촬영
  - 촬영된 8장의 사진 중 원하는 4장을 선택하여 최종 네컷사진 제작
  - 1×4, 2×2 등 실제 네컷사진과 동일한 레이아웃 지원
  - 사용자가 입력한 프롬프트를 기반으로 LLM과 이미지 생성 AI를 활용한 맞춤형 프레임 생성
